...
```js
import path = require('path');  // require('') - import in commonJS modules for Node.js
import HtmlWebpackPlugin = require('html-webpack-plugin'); // html generator
...
module.exports = { // Node.js export
  ...
  "plugins": [new HtmlWebpackPlugin({template: './src/index.html'})], // generates html from template
